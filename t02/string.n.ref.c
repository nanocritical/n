...
#define _nretval (*_nrtr__nretval)
 {
nlang_strings_string_from_static_string(nlang_chars_static_string_mk((const nlang_builtins_u8 *)"test", sizeof("test")-1), &(_nretval));
return;
}
#undef _nretval
}
...
nlang_say(NULL, 1, nlang_chars_static_string_mkdyn__nlang_chars__Ni_show((void *)({ _Ngensym0 = nlang_chars_static_string_mk((const nlang_builtins_u8 *)"test", sizeof("test")-1);
((&_Ngensym0));
; })));
;
nlang_strings_string _Ngensym1 = { 0 };
nlang_strings_string _Ngensym2 = { 0 };
nlang_say(NULL, 1, nlang_strings_string_mkdyn__nlang_chars__Ni_show((void *)({  {
t02_string_foo(&(_Ngensym1));
