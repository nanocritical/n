...
enum toplevel_flags {
  ...
  TOP_IS_FORCE_SYMBOL_EXPORT = 0x10,
  TOP_IS_PROTOTYPE = 0x20,
  TOP_IS_SHADOWED = 0x40,
  TOP_IS_NOT_DYN = 0x80,
  TOP_IS_PREVENT_DYN = 0x100,
  TOP_IS_SHALLOW = 0x200,
  TOP_IS_FUNCTOR = 0x400,
...
enum node_flags {
  ...
  NODE_IS_MOVE_TARGET = 0x10,
  NODE_IS_CALLEES = 0x20,
  NODE_IS_GLOBAL_LET = 0x40,
  NODE_IS_LOCAL_STATIC_CONSTANT = 0x80,
  NODE_IS_GLOBAL_STATIC_CONSTANT = 0x100,
  NODE__TRANSITIVE = NODE_IS_TYPE,
  NODE__ASSIGN_TRANSITIVE = NODE__TRANSITIVE | NODE_IS_MOVE_TARGET,
  NODE__TYPECONSTRAINT_TRANSITIVE = NODE_IS_DEFCHOICE | NODE_IS_DEFCHOICE_HAS_EXTERNAL_PAYLOAD,
  NODE__DETACHED = 0x10000000,
};
