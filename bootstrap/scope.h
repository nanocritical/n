...
ERROR scope_define_ident(const struct module *mod, struct node *scoper, ident id, struct node *node);
ERROR scope_define(const struct module *mod, struct node *scoper, struct node *id, struct node *node);
...
char *scope_definitions_name_list(const struct module *mod, const struct node *scoper);
