...
/*!re2c
  ...
  "?@!" { RUNORBIN(3, TNULCREFBANG, 0, 0); }
  "weak ?@!" { RUNORBIN(7, TNULCREFBANG, 0, 0); }
  "?#" { RUNORBIN(2, TNULREFSHARP, 0, TOPTSHARP); }
  "?@#" { RUNORBIN(3, TNULCREFSHARP, 0, 0); }
  "weak ?@#" { RUNORBIN(7, TNULCREFSHARP, 0, 0); }
  "?$" { RUNORBIN(2, TNULREFWILDCARD, 0, TOPTWILDCARD); }
  "*" { RUNORBIN(1, TREFDOT, TDEREFDOT, TTIMES); }
  "@" { RUNORBIN(1, TCREFDOT, TCREFDOT_POST, 0); }
  "." { RUNORBIN(1, TPREDOT, 0, TDOT); }
  "!" { RUNORBIN(1, TREFBANG, TDEREFBANG, TBANG); }
  "@!" { RUNORBIN(2, TCREFBANG, TCREFBANG_POST, 0); }
  "#" { RUNORBIN(1, TREFSHARP, TDEREFSHARP, TSHARP); }
  "@#" { RUNORBIN(2, TCREFSHARP, TCREFSHARP_POST, 0); }
  "$" { RUNORBIN(1, TREFWILDCARD, TDEREFWILDCARD, TWILDCARD); }
  "@$" { RUNORBIN(2, TCREFWILDCARD, TCREFWILDCARD_POST, 0); }
  "$@$" { RUNORBIN(3, 0, TREFCREFWILDCARD, 0); }
