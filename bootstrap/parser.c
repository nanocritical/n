...
const char *predefined_idents_strings[ID__NUM] = {
  ...
  [ID_TBI_BITWISE_INTEGER] = "`Bitwise_integer",
  [ID_TBI_INTEGER] = "`Integer",
  [ID_TBI_UNSIGNED_INTEGER] = "`Unsigned_integer",
  [ID_TBI_NATIVE_BITWISE_INTEGER] = "`Native_bitwise_integer",
  [ID_TBI_NATIVE_ANYSIGN_BITWISE_INTEGER] = "`Native_bitwise_anysign_integer",
...
static void init_tbis(struct globalctx *gctx) {
  ...
  TBI_BITWISE_INTEGER = gctx->builtin_typs_by_name[ID_TBI_BITWISE_INTEGER];
  ...
  TBI_NATIVE_BITWISE_INTEGER = gctx->builtin_typs_by_name[ID_TBI_NATIVE_BITWISE_INTEGER];
  TBI_NATIVE_ANYSIGN_BITWISE_INTEGER = gctx->builtin_typs_by_name[ID_TBI_NATIVE_ANYSIGN_BITWISE_INTEGER];
