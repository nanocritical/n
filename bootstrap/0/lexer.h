...
static const uint32_t operators[TOKEN__NUM] = {
  ...
  [TASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TPLUS_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TMINUS_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TTIMES_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TDIVIDE_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TMODULO_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TBWAND_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TBWOR_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TBWXOR_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TRSHIFT_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TLSHIFT_ASSIGN] = OP(FALSE, ASSOC_NON, 0x140),
  [TCOMMA] = OP(FALSE, ASSOC_LEFT, 0x130),
  [Tor] = OP(FALSE, ASSOC_LEFT, 0x120),
  [Tand] = OP(FALSE, ASSOC_LEFT, 0x110),
  ...
  [TDIVIDE] = OP(FALSE, ASSOC_LEFT, 0x60),
  [TMODULO] = OP(FALSE, ASSOC_LEFT, 0x60),
  [TTIMES] = OP(FALSE, ASSOC_LEFT, 0x60),
  [TUPLUS] = OP(FALSE, ASSOC_RIGHT, 0x50),
  [TUMINUS] = OP(FALSE, ASSOC_RIGHT, 0x50),
  ...
  [Tdyn] = OP(TRUE, ASSOC_RIGHT, 0x25),
  [TLINIT] = OP(FALSE, ASSOC_RIGHT, 0x21),
