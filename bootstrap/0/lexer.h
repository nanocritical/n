...
static const uint32_t operators[TOKEN__NUM] = {
  ...
  [TBWAND_ASSIGN] = OP(OP_BIN_SYM_BOOL, ASSOC_NON, 0x140),
  [TBWOR_ASSIGN] = OP(OP_BIN_SYM_BOOL, ASSOC_NON, 0x140),
  [TBWXOR_ASSIGN] = OP(OP_BIN_SYM_BOOL, ASSOC_NON, 0x140),
  [TRSHIFT_ASSIGN] = OP(OP_BIN_RHS_U16, ASSOC_NON, 0x140),
  [TLSHIFT_ASSIGN] = OP(OP_BIN_RHS_U16, ASSOC_NON, 0x140),
  ...
  [TEQ] = OP(OP_BIN_SYM_NUM, ASSOC_NON, 0xe0),
  [TNE] = OP(OP_BIN_SYM_NUM, ASSOC_NON, 0xe0),
  [T__CALL] = OP(OP_BIN, ASSOC_NON, 0xd0),
  [TBWOR] = OP(OP_BIN_SYM_BOOL, ASSOC_LEFT, 0xc0),
  [TBWXOR] = OP(OP_BIN_SYM_BOOL, ASSOC_LEFT, 0xb0),
  [TBWAND] = OP(OP_BIN_SYM_BOOL, ASSOC_LEFT, 0xa0),
  [TLSHIFT] = OP(OP_BIN_RHS_U16, ASSOC_NON, 0x90),
  [TRSHIFT] = OP(OP_BIN_RHS_U16, ASSOC_NON, 0x90),
  ...
  [TREFDOT] = OP(OP_UN, ASSOC_RIGHT, 0x40),
  [TREFBANG] = OP(OP_UN, ASSOC_RIGHT, 0x40),
  [TREFSHARP] = OP(OP_UN, ASSOC_RIGHT, 0x40),
  [TNULREFDOT] = OP(OP_UN, ASSOC_RIGHT, 0x40),
  [TNULREFBANG] = OP(OP_UN, ASSOC_RIGHT, 0x40),
  [TNULREFSHARP] = OP(OP_UN, ASSOC_RIGHT, 0x40),
  [TCOLON] = OP(OP_BIN_RHS_TYPE, ASSOC_LEFT, 0x30),
  [Tdyn] = OP(OP_UN_REF, ASSOC_RIGHT, 0x25),
