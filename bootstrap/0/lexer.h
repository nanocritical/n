...
static const uint32_t operators[TOKEN__NUM] = {
  ...
  [TPLUS_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TMINUS_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TTIMES_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TDIVIDE_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TMODULO_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TBWAND_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TBWOR_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TBWXOR_ASSIGN] = OP(OP_ASSIGN, OP_BIN_SYM_NUM, ASSOC_NON, 0x140),
  [TRSHIFT_ASSIGN] = OP(OP_ASSIGN, OP_BIN_NUM_RHS_U16, ASSOC_NON, 0x140),
  [TLSHIFT_ASSIGN] = OP(OP_ASSIGN, OP_BIN_NUM_RHS_U16, ASSOC_NON, 0x140),
  ...
  [TLE] = OP(0, OP_BIN_SYM_NUM, ASSOC_NON, 0xe0),
  [TLT] = OP(0, OP_BIN_SYM_NUM, ASSOC_NON, 0xe0),
  [TGT] = OP(0, OP_BIN_SYM_NUM, ASSOC_NON, 0xe0),
  [TGE] = OP(0, OP_BIN_SYM_NUM, ASSOC_NON, 0xe0),
  ...
  [TLSHIFT] = OP(0, OP_BIN_NUM_RHS_U16, ASSOC_NON, 0x90),
  [TRSHIFT] = OP(0, OP_BIN_NUM_RHS_U16, ASSOC_NON, 0x90),
  ...
  [Tdyn] = OP(0, OP_UN_DYN, ASSOC_RIGHT, 0x25),
