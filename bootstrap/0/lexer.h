...
static const uint32_t operators[TOKEN__NUM] = {
  ...
  [Tin] = OP(OP_BIN_SYM, ASSOC_NON, 0x140),
  ...
  [TNULREFWILDCARD] = OP(OP_UN_REFOF, ASSOC_RIGHT, 0x40),
  ...
  [TWILDCARD] = OP(OP_BIN_ACC, ASSOC_LEFT, 0x20),
  ...
  [TDEREFWILDCARD] = OP(OP_UN_DEREF, ASSOC_LEFT, 0x1f),
};
