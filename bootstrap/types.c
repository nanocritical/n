...
struct typ *TBI_ADDITIVE_ARITHMETIC;
struct typ *TBI_ADDITIVE_ARITHMETIC_ASSIGN;
struct typ *TBI_ARITHMETIC;
struct typ *TBI_ARITHMETIC_ASSIGN;
struct typ *TBI_HAS_BITWISE_OPERATORS;
struct typ *TBI_HAS_BITWISE_OPERATORS_ASSIGN;
struct typ *TBI_INTEGER_ARITHMETIC;
struct typ *TBI_OVERFLOW_ARITHMETIC;
struct typ *TBI_NUMBER_LITERAL_COMPATIBLE;
struct typ *TBI_INTEGER;
struct typ *TBI_UNSIGNED_INTEGER;
struct typ *TBI_NATIVE;
...
struct typ *TBI_GLOBALENV_INSTALLED;
