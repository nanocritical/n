...
static const struct operator operators[TOKEN__NUM] = {
  ...
  [Tinvariant] = OP(0, OP_UN_ASSERT, ASSOC_NON, 0x137),
  [Tpost] = OP(0, OP_UN_ASSERT, ASSOC_NON, 0x137),
  [Tpre] = OP(0, OP_UN_ASSERT, ASSOC_NON, 0x137),
  [Tassert] = OP(0, OP_UN_ASSERT, ASSOC_NON, 0x137),
  ...
  [TWILDCARD] = OP(0, OP_BIN_ACC, ASSOC_LEFT, 0x20),
  [TPOSTQMARK] = OP(0, OP_UN_ISNIL, ASSOC_NON, 0x11),
