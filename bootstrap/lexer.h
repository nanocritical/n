...
enum operator_kind {
  ...
  OP_BIN_ACC = 0x70,
  OP_BIN_OPT_ACC = 0x80,
  OP_BIN_BW_RHS_UNSIGNED = 0x90,
  OP_BIN_RHS_TYPE = 0xa0,
  OP_UN__MASK = 0x0f,
  OP_BIN__MASK = 0xf0,
  OP_KIND__MASK = 0xff,
};
...
static const struct operator operators[TOKEN__NUM] = {
  ...
  [TDOTDOT] = OP(0, OP_BIN, ASSOC_NON, 0x126),
  [TBEGDOTDOT] = OP(0, OP_UN_RANGE, ASSOC_NON, 0x125),
  [TENDDOTDOT] = OP(0, OP_UN_RANGE, ASSOC_NON, 0x125),
  ...
  [TOVPLUS] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x80),
  [TMINUS] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x80),
  [TOVMINUS] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x80),
  [TDIVIDE] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x60),
  [TOVDIVIDE] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x60),
  [TMODULO] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x60),
  [TOVMODULO] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x60),
  [TTIMES] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x60),
  [TOVTIMES] = OP(0, OP_BIN_SYM_ARITH, ASSOC_LEFT, 0x60),
  [TUPLUS] = OP(0, OP_UN_ARITH, ASSOC_NON, 0x50),
  [TOVUPLUS] = OP(0, OP_UN_ARITH, ASSOC_NON, 0x50),
  [TUMINUS] = OP(0, OP_UN_ARITH, ASSOC_NON, 0x50),
  [TOVUMINUS] = OP(0, OP_UN_ARITH, ASSOC_NON, 0x50),
