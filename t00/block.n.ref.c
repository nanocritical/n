...
static nlang_builtins_u32 t00_block_deref(_Ngen_nlang_builtins_ref__nlang_builtins_u32_genN_ p) __attribute__((__nonnull__(1)));
...
nlang_builtins_u32 x = ({ (nlang_builtins_u32)1;
; });
;
...
nlang_chars_static_string y1 = ({ ( ((x > (nlang_builtins_u32)0)) ? ( {
nlang_chars_static_string_mk((const nlang_builtins_u8 *)"test", sizeof("test")-1);
})
 : ( {
nlang_chars_static_string_mk((const nlang_builtins_u8 *)"error", sizeof("error")-1);
})); });
nlang_builtins_u32 z1 = ({ ( (nlang_chars_static_string_operator_eq(((&y1)), ({ _Ngensym1 = nlang_chars_static_string_mk((const nlang_builtins_u8 *)"test", sizeof("test")-1);
((&_Ngensym1));
; }))) ? ( {
(nlang_builtins_u32)0;
})
 : ( {
(nlang_builtins_u32)1;
})); });
...
nlang_chars_static_string y2 = ({ ( ((x > (nlang_builtins_u32)0)) ? ( {
nlang_chars_static_string_mk((const nlang_builtins_u8 *)"test", sizeof("test")-1);
})
 : ( {
nlang_chars_static_string_mk((const nlang_builtins_u8 *)"error", sizeof("error")-1);
})); });
nlang_builtins_i32 z2 = ({ nlang_builtins_i32 tmp = (nlang_builtins_i32)0;
nlang_containers_index_range _Ngensym3 = { 0 };
nlang_containers_index_iterator _Ngensym4 = { 0 };
nlang_containers_index_iterator _Ngensym5 = { 0 };
...
; });
;
nlang_chars_static_string _Ngensym6 = { 0 };
nlang_builtins_assert(nlang_chars_static_string_operator_eq(((&y2)), ({ _Ngensym6 = nlang_chars_static_string_mk((const nlang_builtins_u8 *)"test", sizeof("test")-1);
((&_Ngensym6));
; })));
;
nlang_builtins_assert((z2 == ((nlang_builtins_i32)50 * (nlang_builtins_i32)99)));
nlang_builtins_u32 _Ngensym7 = { 0 };
nlang_builtins_assert((t00_block_deref(({  {
_Ngensym7 = (nlang_builtins_u32)1;
};
((&_Ngensym7));
; })) == (nlang_builtins_u32)1));
;
