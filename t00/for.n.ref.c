...
#ifndef HAS2__Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_
#define HAS2__Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_
static inline nlang_builtins_void _Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_(nlang_builtins_i32 x);
#endif // HAS2__Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_
...
#ifndef HAS3__Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_
#define HAS3__Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_
static inline nlang_builtins_void _Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_(nlang_builtins_i32 x) {
 {
;;
}
}
#endif // HAS3__Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_
...
;
;;
_Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_(m);
};
;
;
;;
...
;
nlang_builtins_i32 k = (nlang_builtins_i32)0;
;
 {
;;
_Ngen_nlang_builtins_unused__nlang_builtins_i32_genN_(k);
;
 {
;;
nlang_builtins_size _Ngensym5 = (nlang_builtins_size)0;
;
nlang_builtins_size _Ngensym6 = (nlang_builtins_size)10;
;
nlang_containers_index_range _Ngensym7 = nlang_containers_range(_Ngensym5, _Ngensym6);
;
_Ngen_nlang_builtins_ref__nlang_containers_index_range_genN_ _Ngensym10 = ((&_Ngensym7));
;
nlang_containers_index_iterator _Ngensym8 = { 0 };
nlang_containers_index_range_iter(_Ngensym10, &(_Ngensym8));
;
_Ngen_nlang_builtins_mutable_ref__nlang_containers_index_iterator_genN_ _Ngensym4 = ((&_Ngensym8));
;
 {
while (({ nlang_builtins_bool _Ngensym9 = nlang_containers_index_iterator_has_next(_Ngensym4);
;
_Ngensym9;
; })) {
;
;
;;
nlang_builtins_size i = nlang_containers_index_iterator_next(_Ngensym4);
;
 {
;;
...
nlang_builtins_i32 _Ngensymc = (nlang_builtins_i32)10;
;
nlang_builtins_i32 _Ngensymd = (j - _Ngensymc);
;
return _Ngensymd;
}
return _nretval;
